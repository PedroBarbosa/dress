...
def input_options(fun):
    ...
    fun = click.option(
        ...
        cls=OptionEatAll,
        required=True,
        help="File(s) referring to the dataset generated. Optionally, a single directory can be provided. If so, all '*dataset.csv.gz' files will be loaded.",
    )(fun)
    ...
    fun = click.option(
        ...
        type=tuple,
        cls=OptionEatAll,
        help="File(s) referring to a second dataset generated. As for the '--dataset' option, a single directory can be provided.",
    )(fun)
