...
def evo_alg_options_generate(fun):
    ...
    fun = click.option(
        ...
        default="ss_usage",
        help="Which type of predictions to consider when '--model' is 'pangolin'. By default, it uses splice site usage, but splice site probabilities (like SpliceAI) can be used.")(fun)
